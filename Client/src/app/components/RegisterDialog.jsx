      ...
      <DialogContent className="bg-card border-border max-w-md">
        <DialogHeader>
          ...
          <DialogDescription className="text-muted-foreground text-sm">
            Join GamerDiary and start tracking your games.
          </DialogDescription>
        </DialogHeader>
        ...
        <form className="flex flex-col gap-4 mt-1" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col gap-1.5">
            <Label htmlFor="reg-username" className="text-foreground text-sm">
              Username
            </Label>
            <input
              id="reg-username"
          ...
          <Button
            type="submit"
            className="mt-1 w-full bg-primary hover:bg-primary/90 text-white disabled:opacity-40"
